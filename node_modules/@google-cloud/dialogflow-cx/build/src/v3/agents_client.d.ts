...
export declare class AgentsClient {
     ...
     *   The first element of the array is an object representing [Agent]{@link google.cloud.dialogflow.cx.v3.Agent}.
     *   Please see the
     ...
     */
    getAgent(request?: protos.google.cloud.dialogflow.cx.v3.IGetAgentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IAgent, protos.google.cloud.dialogflow.cx.v3.IGetAgentRequest | undefined, {} | undefined]>;
     ...
     */
    createAgent(request?: protos.google.cloud.dialogflow.cx.v3.ICreateAgentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IAgent, protos.google.cloud.dialogflow.cx.v3.ICreateAgentRequest | undefined, {} | undefined]>;
     ...
     */
    updateAgent(request?: protos.google.cloud.dialogflow.cx.v3.IUpdateAgentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IAgent, protos.google.cloud.dialogflow.cx.v3.IUpdateAgentRequest | undefined, {} | undefined]>;
     ...
     */
    deleteAgent(request?: protos.google.cloud.dialogflow.cx.v3.IDeleteAgentRequest, options?: CallOptions): Promise<[protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.cx.v3.IDeleteAgentRequest | undefined, {} | undefined]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [AgentValidationResult]{@link google.cloud.dialogflow.cx.v3.AgentValidationResult}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
     ...
     */
    validateAgent(request?: protos.google.cloud.dialogflow.cx.v3.IValidateAgentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IAgentValidationResult, protos.google.cloud.dialogflow.cx.v3.IValidateAgentRequest | undefined, {} | undefined]>;
     ...
     */
    getAgentValidationResult(request?: protos.google.cloud.dialogflow.cx.v3.IGetAgentValidationResultRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IAgentValidationResult, (protos.google.cloud.dialogflow.cx.v3.IGetAgentValidationResultRequest | undefined), {} | undefined]>;
     ...
     */
    exportAgent(request?: protos.google.cloud.dialogflow.cx.v3.IExportAgentRequest, options?: CallOptions): Promise<[LROperation<protos.google.cloud.dialogflow.cx.v3.IExportAgentResponse, protos.google.protobuf.IStruct>, protos.google.longrunning.IOperation | undefined, {} | undefined]>;
     ...
     */
    restoreAgent(request?: protos.google.cloud.dialogflow.cx.v3.IRestoreAgentRequest, options?: CallOptions): Promise<[LROperation<protos.google.protobuf.IEmpty, protos.google.protobuf.IStruct>, protos.google.longrunning.IOperation | undefined, {} | undefined]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [Agent]{@link google.cloud.dialogflow.cx.v3.Agent}.
     ...
     *   for more details and examples.
     */
    listAgents(request?: protos.google.cloud.dialogflow.cx.v3.IListAgentsRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IAgent[], protos.google.cloud.dialogflow.cx.v3.IListAgentsRequest | null, protos.google.cloud.dialogflow.cx.v3.IListAgentsResponse]>;
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing [Agent]{@link google.cloud.dialogflow.cx.v3.Agent} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   [Agent]{@link google.cloud.dialogflow.cx.v3.Agent}. The API will be called under the hood as needed, once per the page,
