...
export declare class SessionsClient {
     ...
     *   The first element of the array is an object representing [DetectIntentResponse]{@link google.cloud.dialogflow.cx.v3.DetectIntentResponse}.
     *   Please see the
     ...
     */
    detectIntent(request?: protos.google.cloud.dialogflow.cx.v3.IDetectIntentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IDetectIntentResponse, protos.google.cloud.dialogflow.cx.v3.IDetectIntentRequest | undefined, {} | undefined]>;
     ...
     */
    matchIntent(request?: protos.google.cloud.dialogflow.cx.v3.IMatchIntentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IMatchIntentResponse, protos.google.cloud.dialogflow.cx.v3.IMatchIntentRequest | undefined, {} | undefined]>;
     ...
     */
    fulfillIntent(request?: protos.google.cloud.dialogflow.cx.v3.IFulfillIntentRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.cx.v3.IFulfillIntentResponse, protos.google.cloud.dialogflow.cx.v3.IFulfillIntentRequest | undefined, {} | undefined]>;
     ...
     *   representing [StreamingDetectIntentRequest]{@link google.cloud.dialogflow.cx.v3.StreamingDetectIntentRequest} for write() method, and
     *   will emit objects representing [StreamingDetectIntentResponse]{@link google.cloud.dialogflow.cx.v3.StreamingDetectIntentResponse} on 'data' event asynchronously.
     *   Please see the
