...
class StreamingVideoIntelligenceServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.stream = {
            streamingAnnotateVideo: new this._gaxModule.StreamDescriptor(gax.StreamType.BIDI_STREAMING, opts.fallback === 'rest'),
        };
    ...
    initialize() {
        ...
        this.streamingVideoIntelligenceServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.videointelligence.v1p3beta1
                    .StreamingVideoIntelligenceService, this._opts, this._providedCustomServicePath);
