...
import gs from '@google-cloud/storage';
...
async function downloadFile(bucketName, srcFilename, destFilename) {
	...
	// Imports the Google Cloud client library
	// mport gs from '@google-cloud/storage';
...
const storage = function(kmsKeyName) {
	this.kmsKeyName = kmsKeyName;
}

storage.prototype.uploadFileToCloud = async function(bucketName, filename) {
	return await uploadFileWithKmsKey(bucketName, filename, this.kmsKeyName);
}

storage.prototype.downloadFileFromCloud = async function(bucketName, srcFilename, destFilename) {
	return await downloadFile(bucketName, srcFilename, destFilename);
}

storage.prototype.listFilesByPrefixInCloudStorage = async function(bucketName, prefix, delimiter) {
	return await listFilesByPrefix(bucketName, prefix, delimiter);
}

storage.prototype.moveFileInCloudStorage = async function(bucketName, srcFilename, destFilename) {
	return await moveFile(bucketName, srcFilename, destFilename);
}
